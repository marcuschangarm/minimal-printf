...
/**
 * Arm Compiler uses __2[s/sn/vsn]printf functions to delegate string formatting
 * to other functions, each dedicated to a specific formatting task.
 *
 * The following four functions replaces the built-in string functions.
 */
...
/**
 * The Arm linker is not able to correctly prune unused helper functions when
 * the string formatting functions are overridden. The following stubs reduce
 * the amount of space these orphaned functions take up.
 */
